...
# +++++++++++++++++++++++++++++++
proc data_time_Ene_TEMP_PRESSURE {path data logfile {first 0} {last -1}} {
...
if {$j != 0} {
  set file [open ${path}/$data.dat w]
  for {set i $firstline} {$i <= $lastline} {incr i} {
    # step, Tot, TEMP, no pressure here
    puts $file "$e($i,2)	$e($i,12)	$e($i,13)"
    }
  close $file
  }
unset ener
