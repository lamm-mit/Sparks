...
# %%
def run_analyze(work_path='1_working_dir',
            sep_chain=1,
            namdc='/home/bni/postdoc_MIT/protein_design/NAMD_2.14_Linux-x86_64-multicore-CUDA/namd2',
            #namdc='/home/bni/postdoc_MIT/protein_design/NAMD_3.0.1_Linux-x86_64-multicore-CUDA/namd3',
            catdcd_commad='/home/bni/postdoc_MIT/protein_design/vmd-1.9.4a55/plugins/LINUXAMD64/bin/catdcd5.2/catdcd',
            eq_step=5000,
    ...
    #print('analyze_MD_results')
    # 3
    analyze_MD_results(work_path=work_path, namdc=namdc)

    #print('run_SMD')
    # 4
    #run_SMD(work_path=work_path, namdc=namdc, n_stage=n_stage)
    # 5
    #merge_SMD_results(work_path=work_path, namdc=namdc, catdcd_commad=catdcd_commad)
    # 6
    #collect_SMD_results(work_path=work_path, namdc=namdc, catdcd_commad=catdcd_commad)
    # 7 create outputs-force extension array, maximum force, and energy
