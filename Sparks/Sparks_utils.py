...
# Helper to define parameters more cleanly
def make_parameters(**kwargs):
    """
    Creates a parameters dictionary for a tool.
    Usage:
        make_parameters(
            sequence=("string", "Protein sequence in one-letter code."),
            length=("integer", "Length of the protein sequence.")
        )
    """
    return {
        name: {
        ...
        for name, (param_type, description) in kwargs.items()
    }
